...
if (0 === window.location.href.indexOf('http://www.myfreecams.com/mfc2/static/player.html')) {
    ...
    var MAssist = (function () {
        ...
        var playWarRegex, isHelperAssigned, assignHelperRegex, removeHelperRegex, isGameActive, StopTopicRegex;
        ...
        var isWarActive, Dealer, Player, isBlackJackActive, BlackJackWinnerRegex, setGamePrizeRegex, setGameTipRegex;
        ...
        function setupHTML() {
            ...
            var txtMenuText = document.createTextNode('AnaliasCountr Chat V3');
        ...
        function modelChanged(modelId) {
            ...
            startGameRegex = /(start|stop) (war|guess|blackjack)!/i;
            setGameTipRegex = /set (war|guess|blackjack)(.*) tip!/i;
            setGamePrizeRegex = /(war|guess|blackjack) prize is (.[^:]+) x/i;
