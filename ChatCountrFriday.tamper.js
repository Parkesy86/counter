...
if (0 === window.location.href.indexOf('http://www.myfreecams.com/mfc2/static/player.html')) {
    ...
    var MAssist = (function () {
        ...
        function setupHTML() {
            ...
            var txtMenuText = document.createTextNode('AnaliasCountr Chat Friday');
        ...
        function postCurrentCount() {
            ...
            if (countDown >= T1) {
                ...
                postChatMessage("/pm DreamOfAnalia for 4999: Hi Guys! 4999tk Nakkey, 99tk Spank/100tk Flash, 1717tk SnaChat 4ever, Vid Sale 4 Vids 999tk(u choose from profile) G/G vid 500tk, TY Guys!");
            }
