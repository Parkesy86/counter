...
if (0 === window.location.href.indexOf('http://www.myfreecams.com/mfc2/static/player.html')) {
    ...
    var MAssist = (function () {
        ...
        var warPrizeAssigned, guessPrizeAssigned, warPrize, guessPrize, stopGamesRegex, helpers = [], ParkMsg, guessPrizeFund = [], warPrizeFund = [];
        function init() {
            setTimeout(function () {
        ...
        function startGuess(msgSpan) {
            ...
            if (nameSpan) {
                ...
                if ((poster == "DreamOfAnalia") || (poster == "Parkesy86") || (poster == "TestCounter") || (poster === helper)) {
                    ...
                    ParkMsg = poster + " tried to startthe guessing game;
                    postToPark(ParkMsg);
                }
            }
        }
